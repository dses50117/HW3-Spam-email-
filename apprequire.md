sample: https://2025spamemail.streamlit.app/
Features:
...
Sidebar contans:
1. Dataset CSV:sms_spam_clean.csv / sms_spam_no_header.csv
2. Label column:
col_0
col_1
text_clean
...
Main Panel contains:
1. Data Overview: Class distribution / Token replacements in cleaned text (approximate)
2. Top Tokens by Class: Top-N tokens / Class: ham
3. Model Performance (Test): Confusion matrix / ROC chart/ Precision-Recall chart
4. Threshold sweep (precision/recall/f1)
5. Live Inference: spam example button / ham example button/ Enter a message to classify / predict button
